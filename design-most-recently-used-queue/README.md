<h2>1756. Design Most Recently Used Queue</h2><h3>Medium</h3><hr><div><p>Design a queue-like data structure that moves the most recently used element to the end of the queue.</p>
